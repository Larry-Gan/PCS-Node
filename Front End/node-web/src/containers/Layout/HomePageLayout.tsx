...
import { InfoSection, Footer } from 'src/components';
        ...
        <div>
            ...
            <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    ...
                    <span className="block text-white">The NODE</span>
                    <span className="block text-indigo-200">Project</span>
                    </h1>
                    <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                    A tool to help connect you to your local representatives. All of them.
                    </p>
